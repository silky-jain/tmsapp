...
/**
 * Servlet implementation class RequestTrainingController
 */
@WebServlet("/RequestTrainingController")
public class RequestTrainingController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RequestTrainingController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		trainingService.requestTraining(training);
		response.sendRedirect("User-Dashboard.jsp?msg=Training Requested Successfully");
	}
